...
def SiT_XL_16(**kwargs):
    return SiT(depth=28, hidden_size=1152, decoder_hidden_size=1152, patch_size=16, num_heads=16, **kwargs)
...
def SiT_L_16(**kwargs):
    return SiT(depth=24, hidden_size=1024, decoder_hidden_size=1024, patch_size=16, num_heads=16, **kwargs)
...
def SiT_B_16(**kwargs):
    return SiT(depth=12, hidden_size=768, decoder_hidden_size=768, patch_size=16, num_heads=12, **kwargs)
